...
const token =  "NzUzOTY1ODQwMTA5NDA0MjYw.X1t3aA.cxLx5kj3-hrSvt-udGIm-7vczt0";
const fs = require("fs");
...
bot.on("ready", () =>{
    ...
    bot.user.setActivity("Controll this Server", {type:"CUSTOM_STATUS"})
   
})

bot.on("message", async message =>{

    if(message.channel.name !== "global" && message.guild.id === "567548294054543381") return;
